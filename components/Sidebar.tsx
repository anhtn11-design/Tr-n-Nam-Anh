...
export const Sidebar: React.FC<SidebarProps> = ({ ideas, onSelectIdea, selectedIdea }) => {
  return (
    <aside className="w-full md:w-[350px] flex-shrink-0 bg-brand-surface border-r border-brand-border flex flex-col overflow-y-auto">
          ...
          <li key={idea.id}>
            ...
            >
              <div className="flex-grow">
                <p className={`font-medium ${selectedIdea?.id === idea.id ? 'text-brand-primary' : 'text-brand-text-main'}`}>{idea.upgradedTitle}</p>
