        ...
        {hasIdeas && (
          <div className="w-full mt-2 p-4 bg-brand-dark rounded-lg border border-brand-muted">
             <form onSubmit={handleRemixSubmit} className="flex flex-col md:flex-row items-center gap-3">
              ...
              <button type="submit" disabled={isRemixing} className="px-5 py-2 bg-emerald-500 text-brand-dark font-semibold rounded-lg hover:bg-emerald-400 transition-colors duration-200 disabled:bg-brand-muted disabled:cursor-not-allowed">
